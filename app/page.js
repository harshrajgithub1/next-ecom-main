...
<section id="hero-1" className="bg--scroll hero-section">
	<img src="/assets/img/slider/slider1.jpg" alt="" className="img-fluid banner-img" />
		...
		<div className="row d-flex align-items-center">
			<div className="col-lg-6 order-lg-2">
				<div className="hero-1-img wow fadeInLeft">
					<img className="img-fluid" src="assets/img/slider/img1.png" alt="hero-image" />
				</div>
			</div>
			<div className="col-lg-6">
				<div className="hero-1-txt color--white wow fadeInRight">
					...
					<p className="p-xl">Trishala Connect bietet dir einzigartige Moglichkeiten auf den neusten Stand der
						Technik zu kommen. Simple better advice</p>
		...
		<div className="row justify-content-center">
			<div className="col-md-10 col-lg-9">
				<div className="section-title mb-70">
					<h2 className="s-50">Wähle drei gratis <span>kategorien</span> für dein Vergleich aus</h2>
					<p className="s-21 color--grey">Lorem ipsum dolor sit amet consectetur adipisicing elit.</p>
				</div>
			</div>
		</div>
		<div className="fbox-wrapper text-center">
			<div className="row row-cols-1 row-cols-md-2 row-cols-lg-4">
				...
				<div className="col">
					<div className="fbox-6 fb-1 wow fadeInUp">
						<div className="img-style">
							<img src="/assets/img/icon/18.png" alt="" className="img-fluid" />
						</div>
						<div className="check-icon">
							<span className="flaticon-check"></span>
						</div>
				...
				<div className="col">
					<div className="fbox-6 fb-1 wow fadeInUp">
						<div className="img-style">
							<img src="/assets/img/icon/10.png" alt="" className="img-fluid" />
						</div>
						<div className="check-icon">
							<span className="flaticon-check"></span>
						</div>
				...
				<div className="col">
					<div className="fbox-6 fb-1 wow fadeInUp">
						<div className="img-style">
							<img src="/assets/img/icon/17.png" alt="" className="img-fluid" />
						</div>
						<div className="check-icon">
							<span className="flaticon-check"></span>
						</div>
				...
				<div className="col">
					<div className="fbox-6 fb-1 wow fadeInUp">
						<div className="img-style">
							<img src="/assets/img/icon/12.png" alt="" className="img-fluid" />
						</div>
						<div className="check-icon">
							<span className="flaticon-check"></span>
						</div>
				...
				<div className="col">
					<div className="fbox-6 fb-1 wow fadeInUp">
						<div className="img-style">
							<img src="/assets/img/icon/13.png" alt="" className="img-fluid" />
						</div>
						<div className="check-icon">
							<span className="flaticon-check"></span>
						</div>
				...
				<div className="col">
					<div className="fbox-6 fb-1 wow fadeInUp">
						<div className="img-style">
							<img src="/assets/img/icon/14.png" alt="" className="img-fluid" />
						</div>
						<div className="check-icon">
							<span className="flaticon-check"></span>
						</div>
				...
				<div className="col">
					<div className="fbox-6 fb-1 wow fadeInUp">
						<div className="img-style">
							<img src="/assets/img/icon/15.png" alt="" className="img-fluid" />
						</div>
						<div className="check-icon">
							<span className="flaticon-check"></span>
						</div>
				...
				<div className="col">
					<div className="fbox-6 fb-1 wow fadeInUp">
						<div className="img-style">
							<img src="/assets/img/icon/16.png" alt="" className="img-fluid" />
						</div>
						<div className="check-icon">
							<span className="flaticon-check"></span>
						</div>
				...
				<div className="col">
					<div className="fbox-6 fb-1 wow fadeInUp">
						<div className="img-style">
							<img src="/assets/img/icon/19.png" alt="" className="img-fluid" />
						</div>
						<div className="check-icon">
							<span className="flaticon-check"></span>
						</div>
		...
		<div className="row d-flex align-items-center">
			<div className="col-md-6">
				<div className="img-block left-column wow fadeInRight">
					<img className="img-fluid" src="/assets/img/img-10.png" alt="content-image" />
				</div>
			</div>
			<div className="col-md-6">
				<div className="txt-block right-column wow fadeInLeft">
					...
					<div className="section-title text-start">
						<h2 className="s-50">Lösungen <span>für ein</span> optimiertes finden</h2>
					</div>
					<p>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Quo culpa alias nulla incidunt animi
						ullam optio quasi quos delectus hic! Quidem illo eligendi facilis ex repellat vero consequuntur
						nulla mollitia.</p>
					<h5 className="s-24">Lorem ipsum dolor sit amet</h5>
					<ul className="simple-list">
						<li className="list-item">
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit. Reprehenderit ducimus modi
								voluptatum repellendus perferendis temporibus.</p>
						</li>
						<li className="list-item">
							<p className="mb-0">Lorem ipsum dolor sit, amet consectetur adipisicing elit. Eius nam eaque
								mollitia. Exercitationem, veritatis minima.</p>
						</li>
					</ul>
				</div>
			</div>
		...
		<div className="row d-flex align-items-center">
				...
				<div className="txt-block left-column wow fadeInRight">
					<div className="cbox-2 process-step">
						...
						<div className="cbox-2-txt">
							<h5 className="s-22 w-700">Umfassende Vergleichsmöglichkeiten</h5>
							<p>Trisfusa bietet eine breite Palette von Smarthome-Geräten und Automationstechnologien zur
								Auswahl. Mit unserer Plattform kannst du Produkte und Lösungen in verschiedenen
								Kategorien vergleichen, um diejenigen zu
								finden, die am besten zu deinen Bedürfnissen passen.</p>
						</div>
					...
					<div className="cbox-2 process-step">
						...
						<div className="cbox-2-txt">
							<h5 className="s-22 w-700">Kompatibilitäts- und Schnittstellenüberprüfung</h5>
							<p> Wir legen besonderen Wert auf die Gewährleistung der Kompatibilität und
								Schnittstellenzugehörigkeit deiner Geräte. Trisfusa hilft dir, sicherzustellen, dass
								alle deine Smarthome-Geräte nahtlos miteinander
								interagieren und reibungslos funktionieren.</p>
						</div>
					...
					<div className="cbox-2 process-step">
						...
						<div className="cbox-2-txt">
							<h5 className="s-22 w-700">Expertenberatung und Benutzerfreundlichkeit</h5>
							<p className="mb-0">Unser Team von Smarthome-Experten steht dir zur Seite und bietet persönliche
								Beratung, um sicherzustellen, dass du fundierte Entscheidungen treffen kannst.
								Gleichzeitig haben wir unsere Plattform benutzerfreundlich
								gestaltet, damit du leicht navigieren und die besten Entscheidungen für dein Smarthome
								treffen kannst.</p>
						</div>
					</div>
				</div>
			...
			<div className="col-md-6 order-first order-md-2">
				<div className="img-block wow fadeInLeft">
					<img className="img-fluid" src="/assets/img/tablet-01.png" alt="content-image"/>
				</div>
			</div>
		</div>
			...
			<div className="row justify-content-md-center row-cols-1 row-cols-md-3">
				<div className="col">
					<div id="rb-1-1" className="rbox-1">
						<div className="rbox-1-img">
							<img className="img-fluid light-theme-img" src="/assets/img/brand-21.png" alt="feature-image" />
						</div>
				...
				<div className="col">
					<div id="rb-1-2" className="rbox-1">
						<div className="rbox-1-img">
							<img className="img-fluid light-theme-img" src="/assets/img/brand-22.png" alt="feature-image" />
						</div>
						<div className="star-rating ico-10 bg--white-100 r-100 clearfix">
							<span className="flaticon-star"></span>
							<span className="flaticon-star"></span>
				...
				<div className="col">
					<div id="rb-1-3" className="rbox-1">
						<div className="rbox-1-img">
							<img className="img-fluid light-theme-img" src="assets/img/brand-23.png" alt="feature-image" />
						</div>
						<div className="star-rating ico-10 bg--white-100 r-100 clearfix">
							<span className="flaticon-star"></span>
							<span className="flaticon-star"></span>
				...
				<div className="row">
					<div className="col">
						<div className="banner-3-txt color--white">
							...
							<p className="p-xl">Endecke Trisfusa und helfe dabei noch mehr Vergleiche zu machen, sende uns
								deine Produkte die wir nicht kennen</p>
							<Link href="#" className="btn r-04 btn--theme hover--tra-white">Jetzt Produkte senden</Link>
