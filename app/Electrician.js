...
const Electrician = () => {
  return (
    <div>
      ...
      <section
        id="comparison"
        class="comparison rel inner-page-hero about-section division"
      >
        <div class="container">
          <div class="row justify-content-center">
            <div class="col-md-8">
              <div class="about-2-title mb-60 text-center wow fadeInUp">
                <span class="section-id">Vergleich</span>
                <h2 class="s-52 mb-30">
            ...
            <div class="col-md-5">
              <div class="txt-block left-column wow fadeInRight">
                ...
                <p>
                  ...
                  nemo assumenda officia dolores quibusdam, omnis veritatis
