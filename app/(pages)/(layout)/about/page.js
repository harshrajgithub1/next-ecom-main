          ...
          <div className="row justify-content-center">
            <div className="col-md-4 mb-4 mb-md-0">
              <div id="tm-2-1" className="team-member wow fadeInUp">
                <div className="team-member-photo r-14">
                  <div className="hover-overlay">
                    <img className="img-fluid w-100" src="/assets/img/team-1.jpg" alt="team-member-foto" />
                    <div className="item-overlay"></div>
                  </div>
                </div>
                <div className="team-member-data">
            ...
            <div className="col-md-4">
              <div id="tm-2-2" className="team-member wow fadeInUp">
                <div className="team-member-photo r-14">
                  <div className="hover-overlay">
                    <img className="img-fluid w-100" src="/assets/img/team-2.jpg" alt="team-member-foto" />
                    <div className="item-overlay"></div>
                  </div>
                </div>
                <div className="team-member-data">
