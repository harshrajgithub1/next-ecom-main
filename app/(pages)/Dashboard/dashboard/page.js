          ...
          <div className="row">
            <div className="col-xl-3 col-lg-4">
              ...
              <ul className="dashboard_menu">
                <li>
                  <Link href="/Dashboard/userProfile/profile">My Profile</Link>
                </li>
                <li>
                ...
                <li>
                  <Link href="/Dashboard/userProfile/addProduct">
                    ADD PRODUCTS
                  </Link>
                </li>
                <li>
                  <Link href="/Dashboard/userProfile/csv">CSV</Link>
                </li>
                <li>
                  <Link href="/Dashboard/userProfile/subscription">
                    SUBSCRIPTION
                  </Link>
                </li>

                <li>
                  <Link href="submit">Submit Quotes</Link>
                </li>
              </ul>
            </div>
                        ...
                        <tr>
                          ...
                          <tr  className="tabile_row">
                            ...
                            <td className="submit">
                              <button
                                type="button"
                                className="btn btn-success succ"
                              >
                                Success
                              </button>
                            </td>
                      ...
                      <nav aria-label="...">
                        <ul className="pagination justify-content-center">
                          <li className="page-item">
                            <a className="page-link" href="className">
                              <i className="jki jki-arrow-left-light"></i>
                            </a>
                          </li>
                          <li className="page-item">
                            <a className="page-link active" href="className">
                              01
                            </a>
                          </li>
                          <li className="page-item">
                          ...
                          <li className="page-item">
                            <a className="page-link" href="className">
                              <i className="jki jki-arrow-right-light"></i>
                            </a>
                          </li>
                        </ul>
                      </nav>
